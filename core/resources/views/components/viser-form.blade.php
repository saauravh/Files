        ...
        <div class="col-md-{{ @$data->width ?? '12' }}">
            <div class="form-group input--group">
                ...
                @elseif($data->type == 'select')
                    <select class="form-select form--control select2" data-minimum-results-for-search="-1" name="{{ $data->label }}" @if ($data->is_required == 'required') required @endif>
                ...
                <label class="form-label form--label">{{ __($data->name) }} @if (@$data->instruction)
