                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                <p class="fw-bold mb-0">@lang('Chat Attachment')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this, user can send file while chatting.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input name="chat_attachment" data-bs-toggle="toggle" data-height="35" data-off="@lang('Disable')" data-offstyle="-danger" data-on="@lang('Enable')" data-onstyle="-success" data-size="large" data-width="100%" type="checkbox" @if (gs('chat_attachment')) checked @endif>
                            </div>
                        </li>
