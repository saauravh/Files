            ...
            <div class="configure-card-header">
                <div class="configure-card-top flex-align gap-4">
                    ...
                    <a href="" class="configure-card-link flex-shrink-0 d-inline-flex gap-1 align-items-center">
                        ...
                        <span class="d-none d-sm-block"><?php echo app('translator')->get('Configure'); ?></span>
                    </a>
                </div>
                        ...
                        <li class="configure-item flex-between">
                            <div class="configure-item-name d-flex align-items-center gap-2 flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center flex-grow-1">
                                    <span><?php echo e(__($config['title'])); ?></span>
                                    <a href="<?php echo e($config['route']); ?>" class="configure-item-btn flex-shrink-0 <?php if(in_array($key, $completedConfig)): ?> disabled <?php endif; ?>">
                                        <i class="fas fa-angle-right"></i>
                                        <span class="d-none d-sm-block"><?php echo app('translator')->get('Configure Now'); ?></span>
                                    </a>
                                </div>
                            </div>
                        </li>
...
<?php $__env->startPush('script-lib'); ?>
    ...
    <script src="<?php echo e(asset('assets/admin/js/jquery.ui.touch-punch.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
<?php endif; ?>
<?php /**PATH /home/pranjal/Pranjal/vscode/Files/core/resources/views/components/config-process.blade.php ENDPATH**/ ?>