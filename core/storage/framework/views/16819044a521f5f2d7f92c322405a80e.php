        ...
        <?php if($form): ?>
            <?php $__currentLoopData = $form->form_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="form-field-wrapper" id="<?php echo e($loop->index); ?>">
                    ...
                    <input type="hidden" name="form_generator[form_width][]" value="<?php echo e(isset($formData->width) ? $formData->width : ''); ?>">
                    <input type="hidden" name="form_generator[form_label][]" class="form-control" value="<?php echo e($formData->name); ?>">
                    <input type="hidden" name="form_generator[instruction][]" class="form-control" value="<?php echo e(isset($formData->instruction) ? $formData->instruction : ''); ?>">
                    ...
                    <div class="form-field">
                        <div class="form-field__item d-flex align-items-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="value"><?php echo e(__(isset($formData->name) ? $formData->name : '')); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="form-field__item">
                            ...
                            <p class="value">
                                <?php if((isset($formData->width) ? $formData->width : '') == '12'): ?>
                                    <?php echo app('translator')->get('100%'); ?>
                                <?php elseif((isset($formData->width) ? $formData->width : '') == '6'): ?>
                                    <?php echo app('translator')->get('50%'); ?>
                                <?php elseif((isset($formData->width) ? $formData->width : '') == '4'): ?>
                                    <?php echo app('translator')->get('33%'); ?>
                                <?php elseif((isset($formData->width) ? $formData->width : '') == '3'): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/pranjal/Pranjal/vscode/Files/core/resources/views/components/generated-form.blade.php ENDPATH**/ ?>