...
! function(e) {
    e.fn.imageUploader = function(t) {
        let n, i = { preloaded: [], imagesInputName: "images", preloadedInputName: "preloaded", label: "Drag & Drop files here or click to browse", extensions: [".jpg", ".jpeg", ".png", ".mp4"], mimes: ["image/jpeg", "image/png", "video/mp4"], maxSize: void 0, maxFiles: void 0 },
            a = this,
            s = new DataTransfer;
        ...
        let o = function() {
                ...
                return e("<i>", { class: "iui-cloud-upload" }).appendTo(i), e("<span>", { text: a.settings.label }).appendTo(i), t.on("click", (function(e) { d(e), n.trigger("click") })), n.on("click", (function(e) { e.stopPropagation() })), n.on("change", p.bind(t)), t
            },
            ...
            l = function(t, i, o) {
                ...
                return e("<i>", { class: "iui-close" }).appendTo(r), o ? (l.attr("data-preloaded", !0), e("<input>", { type: "hidden", name: a.settings.preloadedInputName + "[]", value: i }).appendTo(l)) : l.attr("data-index", i), l.on("click", (function(e) { d(e) })), r.on("click", (function(t) {
                    d(t);
                    let o = l.parent();
            ...
            m = function(e, t) { return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles && ($("#errorModal").modal("show"), 1)) },
            u = function(t, n) {
